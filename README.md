...
3. **API 키 설정**
   - `lib/main.dart`에서 네이버 지도 클라이언트 ID 설정
...
### 프로젝트 통합
- ✅ `hooddak`과 `hooddak_app` 두 프로젝트를 하나의 저장소로 통합
...
- **GitHub**: [https://github.com/Lcmind/hooddak_25.3](https://github.com/Lcmind/hooddak_Readme)
